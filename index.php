    ...
    <body>
                ...
                <nav class="navbar navbar-default retirar-fundo">
                    <div class="container">
                        ...
                        <div class="pull-right social-media">
                            <i class="fa fa-facebook-square icone-facebook"></i>
                            <i class="fa fa-twitter-square icone-twitter"></i>
                            <i class="fa fa-apple icone-itunes"></i>
                            <i class="fa fa-soundcloud icone-soundcloud"></i>
                        </div>
                    </div>
                </nav>
            </section>
        ...
        <section id="seja-um-parceiro" class="seja-um-parceiro">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p>Aenean interdum pulvinar lectus, eu vestibulum quam interdum et. Fusce tincidunt ipsum scelerisque, dapibus risus eu, gravida neque. Mauris justo nulla, rutrum sit amet urna at, volutpat faucibus nunc. Donec mauris eros, tempor sed nibh eget, fermentum sodales dolor. Vestibulum eu tincidunt lectus. Nam scelerisque risus id ex lacinia tempor. Mauris dignissim diam sapien, sit amet venenatis mauris venenatis in. Curabitur ut iaculis nisi. Nullam fringilla lacus sit amet erat dignissim laoreet.</p>
                    </div>
                </div>
            </div>
        </section>
